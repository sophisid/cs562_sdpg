...
object Main {
  ...
  val predefinedLabels = List("Person", "Place", "Event", "Organization", "Location", "Product", "Company", "City", "Country", "Comment","Forum","Post","Tag","TagClass","TagClassMember","TagInPost","TagInComment","TagInPhoto")
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      files.foreach { file =>
        ...
        val noiseLevel = 0.9 // Minimal noise
